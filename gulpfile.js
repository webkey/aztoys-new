...
gulp.task('buildDist', ['cleanDist', 'html:buildAllPages', 'copyImgToDist', 'sassCompilationForDist', 'mergeCssLibs', 'copyLibsScriptsToJs'], function () {
  ...
  gulp.src(['!src/css/temp/**/*.css', '!src/css/_temp/**/*.css', '!src/css/**/_temp_*.css', '!src/css/**/~*.css', '!src/css/all.css', 'src/css/**/*.css'])
      .pipe(gulp.dest(path.dist + '/css'));

  gulp.src(['!src/js/temp/**/*.js', '!src/js/_temp/**/*.js', '!src/js/**/_temp_*.js', '!src/js/**/~*.js', '!src/js/functions.js', 'src/js/**/*.js'])
      .pipe(gulp.dest(path.dist + '/js'));
